    ...
    >
      ...
      <div className="flex justify-between items-end px-2 select-none">
        <div>
          ...
          <h2 className="font-syne font-bold text-3xl text-zinc-900 dark:text-white mt-1">Projects</h2>
        </div>
      ...
      >
        {projects.map((project, idx) => (
          <div 
            ...
            className="w-[88vw] sm:w-[75vw] md:w-[calc(50%-12px)] flex-shrink-0 snap-start bg-white dark:bg-brand-darkCard rounded-[2rem] p-8 shadow-soft dark:shadow-soft-dark border border-zinc-200/30 dark:border-zinc-800/20 flex flex-col justify-between min-h-[280px] group hover:-translate-y-1.5 cursor-pointer bento-transition select-none will-change-transform"
          >
